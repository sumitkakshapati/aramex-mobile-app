                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CardWrapper(
                          ...
                          topMargin: 16.hp,
                          verticalPadding: 4,
                          child: BlocBuilder<BankAccountListCubit, CommonState>(
                                  ...
                                  children: List.generate(
                                    ...
                                    (index) {
                                      return CustomListTile(
                                        ...
                                        suffixIcon: _selectedBankAccount?.id ==
                                                state.data[index].id
                                            ? Icons.check_rounded
                                            : null,
                                  ...
                                  children: [
                                    ...
                                    ValueListenableBuilder<List<BankBranch>>(
                                      ...
                                      builder: (context, bankBranches, _) {
                                        return CustomTextField(
                                          label:
                                              LocaleKeys.selectBankBranch.tr(),
